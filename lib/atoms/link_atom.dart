...
class LinkAtom extends StatefulWidget {
  const LinkAtom({Key? key, required this.title}) : super(key: key);
  final String title;

  static const routeName = '/link';

  @override
  State<LinkAtom> createState() => _LinkAtomState();
}

class _LinkAtomState extends State<LinkAtom> {
